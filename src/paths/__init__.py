...
from modules.ccimar11_planejamento import CCIMAR11_DIR, CCIMAR11_PATH, TEMPLATE_TEST1_PATH, TEMPLATE_TEST2_PATH, TEMPLATE_TEST3_PATH, OBJETIVOS_NAVAIS_PATH
...
__all__ = [
    ...
    "CCIMAR11_DIR", "CCIMAR11_PATH", "TEMPLATE_TEST1_PATH", "TEMPLATE_TEST2_PATH", "TEMPLATE_TEST3_PATH", "OBJETIVOS_NAVAIS_PATH",
